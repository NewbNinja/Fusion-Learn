...
public class SessionInfoListUIItem : MonoBehaviour
{
    ...
    SessionInfo sessionInfo;        // Fusion class that hosts all information about the session (playercount, name, map etc)
    ...
    public void SetInformation(SessionInfo sessionInfo)
    {
        ...
        // Enable/Disable JOIN Button based on connected player count
